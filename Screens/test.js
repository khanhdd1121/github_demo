...
export default function Home({navigation}) {
  ...
  const check = data => {
    ...
    if (a.selected == true && a.answer == 'true') {
      Alert.alert('Chúc mừng bạn đã đoán đúng', 'Bạn có muốn đi tiếp ?', [
        {
          text: 'Cancel',
        },
        {
      ...
      data[0].selected == null ||
      data[1].selected == null ||
      data[2].selected == null ||
      data[3].selected == null
    ) {
      ...
      {loading ? (
        ...
        <View style={{flex: 1}}>
          ...
          <View style={{flex: 1, flexDirection: 'row', marginTop: 20}}>
            ...
            <TouchableOpacity style={style.check} onPress={() => check(data)}>
